...
import type { Asignacion, CreateAsignacionDto, UpdateAsignacionDto } from "../assignmentsService"
...
export const AssignmentModal = ({ asignacion, onClose, onCreate, onUpdate }: Props) => {
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
                ...
                <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        >
                            {loading ? <Spinner size="sm" /> : isEditing ? "Guardar cambios" : "Crear"}
                        </button>
                    </div>
                </form>
            </div>
